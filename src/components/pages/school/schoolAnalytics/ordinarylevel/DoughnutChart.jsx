...
function DoughnutChart() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      await axios
        .get(`http://localhost:8000/results/ordinaryassessmentsanalysis/${id}`)
        ...
        .then(function(res) {
          for (const key in res) {
            ...
            if (marks < 25) {
              ...
              marksBetween25and50=Math.round((marksbetween25and50Counter /totalNumberStudents)*100)
              //break;
            } else if (marks <= 75) {
              marksbetween50and75Counter = marksbetween50and75Counter + 1;
             marksBetween50and75= Math.round((marksbetween50and75Counter /totalNumberStudents)*100)
             // break;
            } else {
              marksbetween75and100Counter = marksbetween75and100Counter + 1;
               marksBetween75and100=(marksbetween75and100Counter /totalNumberStudents )*100;
             // break;
            }
          }
            const data = [
              { name: "Marks with range 0-25 ", 
              value: marksBetween0and25 ,
              },
              {
  ...
  return (
    <div className="doughnutChart">
      <span className="doughnutChartTitle">
        S3 Students Performance In All Assessment
      </span>
      <div className="chart">
